...
class ChatbotEngine:
    ...
    def _get_agent_response(
        ...
        system_prompt = (
            ...
            "STRICT RULES:\n"
            "1. SCOPE: ONLY answer Unifier database questions. If the user asks a non-Unifier general knowledge question (e.g. weather, sports, history, general coding), respond EXACTLY: "
